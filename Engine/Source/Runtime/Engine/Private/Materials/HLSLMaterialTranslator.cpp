...
bool FHLSLMaterialTranslator::Translate()
{
	STAT(double HLSLTranslateTime = 0);
	{
		...
		//NE-START
		Chunk[MP_CustomData2Float3]				= Material->CompilePropertyAndSetMaterialProperty(MP_CustomData2Float3	, this);
		//NE-END
...
void FHLSLMaterialTranslator::GetMaterialEnvironment(EShaderPlatform InPlatform, FShaderCompilerEnvironment& OutEnvironment)
{
	...
	{	
		...
		//NE-START
		if (ShadingModels.HasShadingModel(MSM_ApproximatingTranslucency))
		{
			OutEnvironment.SetDefine(TEXT("MATERIAL_SHADINGMODEL_APPROXIMATINGTRANSLUCENCY"), TEXT("1"));
			NumSetMaterials++;
		}
		if (ShadingModels.HasShadingModel(MSM_PreintegratedCheapSSS))
		{
			OutEnvironment.SetDefine(TEXT("MATERIAL_SHADINGMODEL_PREINTEGRATEDCHEAPSSS"), TEXT("1"));
			NumSetMaterials++;
		}
		//NE-END
...
{	
	...
	//NE-START
	LazyPrintf.PushParam(*GenerateFunctionCode(MP_CustomData2Float3));
	//NE-END
