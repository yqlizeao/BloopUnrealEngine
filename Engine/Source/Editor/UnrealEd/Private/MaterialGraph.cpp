...
void UMaterialGraph::RebuildGraph()
{
	...
	if (!MaterialFunction)
	{
		...
		//NE-START
		MaterialInputs.Add( FMaterialInputInfo(FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_CustomData2Float3, Material), MP_CustomData2Float3, FMaterialAttributeDefinitionMap::GetDisplayNameForMaterial(MP_CustomData2Float3, Material)));
		//NE-END
